...
class TFTBenchmarkBase(benchmark_base.BenchmarkBase):
  ...
  def _benchmarkAnalyzeAndTransformDataset(self, force_tf_compat_v1):
  ...
  def benchmarkAnalyzeAndTransformDatasetTFCompatV1(self):
    ...
    """
    self._benchmarkAnalyzeAndTransformDataset(force_tf_compat_v1=True)
  ...
  def benchmarkAnalyzeAndTransformDatasetTF2(self):
    ...
    taken for the whole pipeline.
    """
    self._benchmarkAnalyzeAndTransformDataset(force_tf_compat_v1=False)

  def _benchmarkRunMetaGraphDoFnManualActuation(self, force_tf_compat_v1):
  ...
  def benchmarkRunMetaGraphDoFnManualActuationTFCompatV1(self):
    ...
    wall time taken.
    """
    self._benchmarkRunMetaGraphDoFnManualActuation(force_tf_compat_v1=True)
  ...
  def benchmarkRunMetaGraphDoFnManualActuationTF2(self):
    ...
    wall time taken.
    """
    self._benchmarkRunMetaGraphDoFnManualActuation(force_tf_compat_v1=False)
